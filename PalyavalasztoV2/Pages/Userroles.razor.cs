...
namespace PalyavalasztoV2.Pages
{
    public partial class Userroles
    {
        ...
        protected IEnumerable<PalyavalasztoV2.Models.main.userrole> userroles;

        protected RadzenDataGrid<PalyavalasztoV2.Models.main.userrole> grid0;
        ...
        protected async Task EditRow(DataGridRowMouseEventArgs<PalyavalasztoV2.Models.main.userrole> args)
        {
            await DialogService.OpenAsync<EditUserrole>("Edit userrole", new Dictionary<string, object> { {"UserId", args.Data.UserId} });
        }

        protected async Task GridDeleteButtonClick(MouseEventArgs args, PalyavalasztoV2.Models.main.userrole userrole)
        {
            try
            {
                ...
                await mainService.ExportuserrolesToExcel(new Query
{
    ...
    Select = string.Join(",", grid0.ColumnsCollection.Where(c => c.GetVisible() && !string.IsNullOrEmpty(c.Property)).Select(c => c.Property.Contains(".") ? c.Property + " as " + c.Property.Replace(".", "") : c.Property))
        ...
        protected async Task GetChildData(PalyavalasztoV2.Models.main.userrole args)
        {
            userrole = args;
        ...
        protected async Task employeesAddButtonClick(MouseEventArgs args, PalyavalasztoV2.Models.main.userrole data)
        {
        ...
        protected async Task employeesRowSelect(DataGridRowMouseEventArgs<PalyavalasztoV2.Models.main.employee> args, PalyavalasztoV2.Models.main.userrole data)
        {
