...
CREATE TABLE `employees` (
  ...
  `Language` text COLLATE utf8mb3_hungarian_ci,
  `HighestEducation` text COLLATE utf8mb3_hungarian_ci,
  `NameofSchool` text COLLATE utf8mb3_hungarian_ci,
  `PreviousWork` text COLLATE utf8mb3_hungarian_ci,
  `Introduction` text COLLATE utf8mb3_hungarian_ci,
  `Address` varchar(100) COLLATE utf8mb3_hungarian_ci DEFAULT NULL,
  `Profession` varchar(120) COLLATE utf8mb3_hungarian_ci DEFAULT NULL,
...
INSERT INTO `employees` VALUES (1,10,'string',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `employers` (
  ...
  `CompanyLocation` varchar(150) COLLATE utf8mb3_hungarian_ci DEFAULT NULL,
  `Size` varchar(45) COLLATE utf8mb3_hungarian_ci DEFAULT NULL,
  `enterprisetype` varchar(45) COLLATE utf8mb3_hungarian_ci DEFAULT NULL,
...
INSERT INTO `employers` VALUES (1,10,'nando','string','string',NULL,NULL,NULL),(2,10,'string','string','string',NULL,NULL,NULL),(10,10,'string','string','string',NULL,NULL,NULL),(30,10,'string','string','string',NULL,NULL,NULL),(31,0,'string','string','string',NULL,NULL,NULL),(32,0,'string','string','string',NULL,NULL,NULL);
...
CREATE TABLE `jobs` (
  ...
  `Picture` text COLLATE utf8mb3_hungarian_ci,
  `Position` varchar(45) COLLATE utf8mb3_hungarian_ci DEFAULT NULL,
  PRIMARY KEY (`JobID`)
...
INSERT INTO `jobs` VALUES (2,0,'string','string','string','string',0,NULL,NULL),(3,0,'string','string','string','string',0,NULL,NULL),(4,NULL,'cxycxcy','cyxcycíyc',NULL,NULL,11000,NULL,NULL),(5,NULL,'cxycxcy','cyxcycíyc',NULL,NULL,11000,NULL,NULL),(6,NULL,'cxycxcy','cyxcycíyc',NULL,NULL,11000,NULL,NULL),(7,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(8,NULL,'adad','adadad',NULL,'vyxxv',10000,NULL,NULL);
...
-- Dump completed on 2024-04-18 11:31:15
